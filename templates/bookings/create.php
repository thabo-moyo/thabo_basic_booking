...
<form method="POST" action="/bookings" id="booking-form">
    ...
    <input type="datetime-local" id="start_time" name="start_time" value="<?= htmlspecialchars($data['start_time'] ?? '') ?>" required>

    <label for="end_time">End Time *</label>
    <input type="datetime-local" id="end_time" name="end_time" value="<?= htmlspecialchars($data['end_time'] ?? '') ?>" required>
